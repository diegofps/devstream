...
TOPIC_DEVICE_JOYPAD = [f"DeviceReader:{x}" for x in REQUIRED_DEVICES]
TOPIC_JOYPAD_STATE  = "GulikitKK3Max:State"
...
class BaseJoypadNode(Reflex):
    ...
    def __init__(self, shadow):
        ...
        self.configure_states(TOPIC_JOYPAD_STATE, TOPIC_DEVICE_JOYPAD)
...
def on_load(shadow):
    ...
    shadow.mind.emit(TOPIC_JOYPAD_STATE, "Joypad_N", 50)
