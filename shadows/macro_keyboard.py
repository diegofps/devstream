    ...
    "Arduino LLC Arduino Leonardo": {
        ...
        "actions": {
            "state1": {
                ...
                (e.KEY_F,1):[("record","MA"), ("notify", "Rec", "MA", 1)],
                (e.KEY_E,1):[("record","MB"), ("notify", "Rec", "MB", 1)],
                (e.KEY_D,1):[("record","MC"), ("notify", "Rec", "MC", 1)],
                (e.KEY_C,1):[("record","MD"), ("notify", "Rec", "MD", 1)],
                (e.KEY_B,1):[("record","ME"), ("notify", "Rec", "ME", 1)],
                (e.KEY_A,1):[("record","MF"), ("notify", "Rec", "MF", 1)],
                (e.KEY_X,1):[("record","MG"), ("notify", "Rec", "MG", 1)],
                (e.KEY_W,1):[("record","MH"), ("notify", "Rec", "MH", 1)],
                (e.KEY_V,1):[("record","MI"), ("notify", "Rec", "MI", 1)],
                (e.KEY_U,1):[("record","MJ"), ("notify", "Rec", "MJ", 1)],
                (e.KEY_T,1):[("record","MK"), ("notify", "Rec", "MK", 1)],
                (e.KEY_S,1):[("record","ML"), ("notify", "Rec", "ML", 1)],
                
                (e.KEY_L,1):[("save",), ("notify", "Rec", "", 0)],
                (e.KEY_K,1):[("save",), ("notify", "Rec", "", 0)],
                (e.KEY_J,1):[("save",), ("notify", "Rec", "", 0)],
                (e.KEY_I,1):[("save",), ("notify", "Rec", "", 0)],
                (e.KEY_H,1):[("save",), ("notify", "Rec", "", 0)],
                (e.KEY_G,1):[("save",), ("notify", "Rec", "", 0)],
                (e.KEY_3,1):[("save",), ("notify", "Rec", "", 0)],
                (e.KEY_2,1):[("save",), ("notify", "Rec", "", 0)],
                (e.KEY_1,1):[("save",), ("notify", "Rec", "", 0)],
                (e.KEY_0,1):[("save",), ("notify", "Rec", "", 0)],
                (e.KEY_Z,1):[("save",), ("notify", "Rec", "", 0)],
                (e.KEY_Y,1):[("save",), ("notify", "Rec", "", 0)],
            },
        },
    },
